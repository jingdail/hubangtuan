		...
		<view class="renwu-box-step">
			...
			<view class="qrcode-container">
				...
				<view class="btn">
					...
					<view class="" @tap="downloadQrcode()">
						<view class="down-wx">
							<view class="cuIcon-down"></view>
						</view>
						<view class="">保存扫码</view>
					</view>
				</view>
			</view>
...
<script>
	export default {
		...
		methods: {
			...
			sendWechat: function() {
				// #ifdef APP-PLUS
			let iswechat = plus.runtime.isApplicationExist({
					pname:"com.tencent.mm",
					action:"weixin://"
				}
			)
			if(!iswechat){
				this.$queue.showToast('未安装微信活着版本过低');
				return false;
			}
				uni.share({
					provider: "weixin",
...
<style>
	...
	.qrcode-container view {
		flex: 1;
	}

	.qrcode-container .pic image {
		width: 300upx;
		height: 300upx;
	}
