    ...
    <view style="position: relative;">
		...
		<view class="u-box" >
			<view class="form-label">
				<textarea placeholder="请填写文字向接单人说明:需要助力的软件名字和怎么帮你完成助力."  @input="getRenwuInfo"/>
			</view>	
					
			<view class="form-label">
				<input placeholder="请粘贴完整的口令,增删口令会导致口令失败."  @input="getRenwuUrl"/>
			</view>	
		</view>
		...
		<view class="form-box">
			...
			<view class="shiliimg">
				...
				<image :src="detail.yanzhengtu" @click="previewImage()" class="yzt" mode="widthFix">
			</view>
		</view>
	...
	export default {
	    ...
	    methods: {
			...
			submitRenwu(){
				...
				param.pic = this.Team_yanzhengtu
