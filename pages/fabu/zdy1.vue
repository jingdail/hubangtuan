<template>
    <view style="position: relative;">
		...
		<view class="u-box" >
			...
			<view class="form-label">
				<input placeholder="添加任务网址"  @input="getRenwuUrl"/>
			</view>	
		</view>
		...
		<view class="form-box">
			...
			<view class="shiliimg">
				...
				<image :src="Team_yanzhengtu" @click="previewImage()" class="yzt" mode="widthFix">
			</view>
		</view>
	...
	export default {
	    ...
	    methods: {
			...
			submitRenwu(){
				...
				if(this.Team_yanzhengtu==null || this.Team_yanzhengtu==''){
